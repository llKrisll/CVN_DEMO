...
import com.synapsis.cvn.event.OnRegistrationCompleteEvent;
import com.synapsis.cvn.exception.InvalidOldPasswordException;
import com.synapsis.cvn.exception.UserNotFoundException;
import com.synapsis.cvn.persistence.entity.User;
import com.synapsis.cvn.persistence.entity.VerificationToken;
import com.synapsis.cvn.security.ISecurityUserService;
import com.synapsis.cvn.services.interfaces.IUserService;
import com.synapsis.cvn.util.GenericResponse;
...
public class RegistrationController {
    ...
    public String confirmRegistration(final Locale locale, final Model model, @RequestParam("token") final String token) {
        ...
        if (result == null) {
            ...
            return "redirect:/security/login?lang=" + locale.getLanguage();
        }
        if (result == "expired") {
        ...
        return "redirect:/security/badUser.html?lang=" + locale.getLanguage();
    }
    ...
    public String showChangePasswordPage(final Locale locale, final Model model, @RequestParam("id") final long id, @RequestParam("token") final String token) {
        ...
        return "redirect:/security/updatePassword.html?lang=" + locale.getLanguage();
    }
